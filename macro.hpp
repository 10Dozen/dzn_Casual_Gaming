...
#define gADDON_NAME_VAR dzn_CG
#define ADDON_NAME_VAR QUOTE(gADDON_NAME_VAR)
#define GVAR(X) gADDON_NAME_VAR##_##X
#define SVAR(X) QUOTE(GVAR(X))

#define FORMAT_VAR(X) format ["%1_%2", ADDON_NAME_VAR, X]
